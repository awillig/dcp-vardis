...
RES_DIR = "/local/spe107/BulkRuns_Nov22/Experiment2ResBulk"
...
for (bec_per, rep, num_sum) in itertools.product(beacon_period, num_repetitions, num_summaries):
    ...
    for n in range(len(node_cnt)):
        ...
        filelist = list(glob.iglob(f"{RES_DIR}/General-endNodeX=1120,nodeCnt={num_nodes},*,beaconPeriod={bec_per}ms,numRepetitions={rep},numSummaries={num_sum}-#*.sca"))
